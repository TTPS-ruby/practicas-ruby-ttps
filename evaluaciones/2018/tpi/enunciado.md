...
| `DELETE /questions/:question_id` | Borra la pregunta existente identificada por el parámetro `:id`. No se debe permitir el borrado si la pregunta tiene al menos una respuesta, o si la petición no es realizada por el usuario que publicó la pregunta. | Sí |
