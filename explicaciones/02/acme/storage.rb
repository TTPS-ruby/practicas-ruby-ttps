...
#     # => "Argentina"
#
# Pueden obtenerse todos los identificadores almacenados para un tipo particular:
#
...
#
#     ACME::Storage[:country].values
#     # => [#<Country:0x007f9b14241948 @iso_code=:ar, @name="Argentina">]
module ACME
  class Storage
